...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/api/vi/diagnoses").hasAuthority(Permission.DIAGNOSES_READ.getPermission())
                .antMatchers(HttpMethod.GET, "/patient").hasAuthority(Permission.PATIENT_LOAD.getPermission())
                .antMatchers(HttpMethod.GET, "/doctor").hasAuthority(Permission.DOCTOR_LOAD.getPermission())
                .antMatchers(HttpMethod.GET, "/admin").hasAuthority(Permission.ADMIN_LOAD.getPermission())
                .anyRequest()
                .authenticated()
                .and()
                .apply(jwtConfigurer);
